                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-3 mt-md-0">
                            <a href="{{route('admin-coupons.create')}}" class="btn btn-info d-flex align-items-center">
                                <i class="ti ti-new-section text-white me-1 fs-5"></i> Add Coupon
                            </a>
                        </div>
                    </div>
                </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="action-btn">
                                                    <a href="{{route('admin-coupons.edit',$row->id)}}" class="btn btn-sm btn-primary">
                                                        <i class="ti ti-pencil fs-5"></i>
                                                    </a>
                                                    <a href="{{ route('admin-coupons.destroy', $row->id) }}"
                                                    ...
                                                    <form id="delete-form-{{ $row->id }}" action="{{ route('admin-coupons.destroy', $row->id) }}" method="get" style="display: none;">
                                                        @csrf
                                                    </form>
