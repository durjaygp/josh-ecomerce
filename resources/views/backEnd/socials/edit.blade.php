                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="exampleInputtext" placeholder="Example: Facebook" value="{{$social->name}}">
                                    <input type="hidden" name="id" class="form-control" id="" placeholder="Example: Facebook" value="{{$social->id}}">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Icon</label>
                                    <input type="text" name="icon" class="form-control" id="exampleInputtext" placeholder="Example: fa fa-facebook" value="{{$social->icon}}">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Link</label>
                                    <input type="text" name="link" class="form-control" id="exampleInputtext" placeholder="Example: https://www.facebook.com/" value="{{$social->link}}">
                                </div>
                            </div>
                            <div class="col-12">
