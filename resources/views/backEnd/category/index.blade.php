                                ...
                                <table id="zero_config"
                                    ...
                                    @foreach($categories as $row)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$row->name}}</td>
                                            <td> @if($row->is_featured == 2) Not Featured @elseif($row->is_featured == 1)  <span class="badge bg-secondary">Featured</span> @else Not Featured  @endif </td>
                                            <td>
                                                @if($row->design_format == 2)
                                                    Format 2
                                                @elseif($row->design_format == 1)
                                                    Format 1
