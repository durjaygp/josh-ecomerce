...
@section('title','Update Affiliate Product')
@section('content')
        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-4 ">
                            <h2>Update Affiliate Product</h2>
                        </div>
                ...
                <div class="card-body">
                    <form method="post" action="{{ route('affiliate.update', $affiliateProduct->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Blog <span class="text-danger">*</span></label>
                                    <select name="blog_id[]" class="select2 form-control bg-success" multiple="multiple" title="Select Blog" required>
                                        @foreach($blogs as $blog)
                                            <option value="{{ $blog->id }}" @if(in_array($blog->id, json_decode($affiliateProduct->blog_id, true))) selected @endif>{{ $blog->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="name" class="form-control" id="name" placeholder="Product name" value="{{ $affiliateProduct->name }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="price" class="form-control" id="price" placeholder="Price" value="{{ $affiliateProduct->price }}" required>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="link" class="form-control" id="link" placeholder="Link" value="{{ $affiliateProduct->link }}" required>
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="description" class="form-label fw-semibold">Short description <span class="text-danger">*</span></label>
                                    <textarea name="description" id="description" class="form-control" placeholder="Short description" required>{{ $affiliateProduct->description }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <img src="{{ asset($affiliateProduct->image) }}" alt="Current Image" style="max-width: 100px; margin-top: 10px;">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    ...
                                    <select name="status" id="status" class="form-select" required>
                                        <option value="1" @if($affiliateProduct->status == 1) selected @endif>Publish</option>
                                        <option value="2" @if($affiliateProduct->status == 2) selected @endif>Draft/Unpublished</option>
                                    </select>
                                </div>
                            </div>
                            <hr>
