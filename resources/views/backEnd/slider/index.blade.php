                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="mt-3 col-md-8 text-end d-flex justify-content-md-end justify-content-center mt-md-0">
                            <a href="{{route('admin-slider.create')}}" class="btn btn-info d-flex align-items-center">
                                <i class="text-white ti ti-new-section me-1 fs-5"></i> New Slider
                            </a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-btn">
                                                <a href="{{route('admin-slider.edit',$row->id)}}" class="btn btn-sm btn-primary">
