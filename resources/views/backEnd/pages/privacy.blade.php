...
@section('title','Update Privacy Policy Page')
@section('content')
    <div class="container-fluid">
        ...
        <div class="widget-content searchable-container list">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" action="{{route('page.homePrivacySave')}}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    <label for="exampleInputPassword1" class="form-label fw-semibold">Page Title</label>
                                    <input type="text" name="page_title" class="form-control" placeholder="Page Title" value="{{$row->page_title}}">
                                </div>
                            </div>
                            <div class="col-lg-12">
                                <div class="mb-4">
                            ...
                            <div class="col-lg-12">
                                <div class="mb-4">
                                    ...
                                    <textarea name="content" id="summernote" cols="10" rows="5" class="form-control" placeholder="Write a short Description">{{$row->content}}</textarea>
